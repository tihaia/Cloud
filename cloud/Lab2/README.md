...
1. Ознакомление с вкладкой Status checks.

   - Эта вкладка позволяет быстро определить, выявил ли Amazon EC2 какие-либо проблемы, которые могут помешать работе приложений.
...
2. Ознакомление с вкладкой _Monitoring_.

   - Эта вкладка отображает метрики Amazon CloudWatch для инстанса.
...
Это полезно, когда необходим точный контроль состояния сервера в реальном времени, например если на сервере работают важные приложения или нужен детальный анализ производительности.
